...
const FOLDERS: FolderItem[] = [
  { id: 1, folderName: 'recordings-2025-06', category: 'recordings', fileCount: 128, lastModified: '25.06.30' },
  { id: 2, folderName: 'recordings-2025-07', category: 'recordings', fileCount: 94, lastModified: '25.07.29' },
  { id: 3, folderName: 'recordings-2025-08', category: 'recordings', fileCount: 176, lastModified: '25.08.31' },
  { id: 4, folderName: 'calls-2025-09', category: 'calls', fileCount: 63, lastModified: '25.09.18' },
]
    ...
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      <header className="h-14 shrink-0 border-b border-slate-200 bg-white flex items-center gap-2 px-6">
        ...
        <nav className="flex items-center gap-0.5 text-sm min-w-0">
          ...
          <span className="text-slate-800 font-medium px-1 text-sm">폴더목록</span>
        </nav>
      </header>
            ...
            <Table>
              <TableHeader className="sticky top-0 z-10 bg-slate-50">
                <TableRow className="border-b border-slate-200 hover:bg-transparent">
                  ...
                  <TableHead className="h-10 px-6 text-right text-[11px] font-semibold uppercase tracking-[0.06em] text-slate-400">최근 수정</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
