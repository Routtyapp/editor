    ...
    <aside className="w-72 border-l border-slate-200 flex flex-col shrink-0 bg-slate-50/30">
      ...
      <div className="px-4 py-3 shrink-0 flex items-center bg-white">
        <div className="flex-1 flex justify-end pr-2">
          <Button className="h-8 w-[124px] border border-slate-600 bg-white text-xs font-medium text-slate-700 hover:bg-slate-50" onClick={() => {}}>
            진행상태 저장
          </Button>
        </div>
        <div className="h-5 w-px bg-slate-300 shrink-0" />
        <div className="flex-1 flex justify-start pl-2">
          <Button className="h-8 w-[124px] text-xs font-medium" onClick={() => {}}>
            작업 완료
          </Button>
        </div>
      </div>
